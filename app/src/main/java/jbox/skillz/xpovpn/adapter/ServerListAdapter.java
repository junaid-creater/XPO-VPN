package jbox.skillz.xpovpn.adapter;
...
import jbox.skillz.xpovpn.activity.BaseActivity;
import jbox.skillz.xpovpn.model.Server;
import jbox.skillz.xpovpn.util.ConnectionQuality;
import jbox.skillz.xpovpn.util.CountriesNames;
